...
def test_return_map():
    ...
    body = wf.steps[0].body
    assert isinstance(body.returns, dict)
...
def test_raise_string():
    ...
    body = wf.steps[0].body
    assert body.raises == "Something went wrong"
...
def test_raise_map():
    ...
    body = wf.steps[0].body
    assert isinstance(body.raises, dict)
